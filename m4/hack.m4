...
This file was extended by m4_ifset([AC_PROJECT_NAME], [AC_PROJECT_NAME ])dnl
$as_me[]m4_ifset([AC_PROJECT_VERSION], [ AC_PROJECT_VERSION]), which was
generated by m4_PROJECT_STRING.  Invocation command line was
...
cat >>$CONFIG_STATUS <<_ACEOF
ac_cs_version="\\
m4_ifset([AC_PROJECT_NAME], [AC_PROJECT_NAME ])config.status[]dnl
m4_ifset([AC_PROJECT_VERSION], [ AC_PROJECT_VERSION])
configured by $[0], generated by m4_PROJECT_STRING,
