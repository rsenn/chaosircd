...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_DATA(int)            module_log;
CHAOS_DATA(struct sheap)   module_heap;
CHAOS_DATA(struct list)    module_list;
CHAOS_DATA(struct timer *) module_timer;
CHAOS_DATA(uint32_t)       module_id;
