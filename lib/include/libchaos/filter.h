...
filter_prog_heap;                    /* heap containing the actual filters */
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void filter_set_name(struct filter *fptr, const char *name))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void filter_rule_add(struct filter *fptr, int type, int action,
                               uint32_t data1, uint32_t data2,
                               uint64_t lifetime))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void filter_rule_insert(struct filter *fptr, int type, int action,
                                  uint32_t data1, uint32_t data2,
                                  uint64_t lifetime))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void filter_rule_delete(struct filter *fptr, int type, int action,
                                  uint32_t data1, uint32_t data2))
 ...
 * ------------------------------------------------------------------------ */
CHAOS_API(int filter_attach_socket(struct filter *fptr, int fd))

/* ------------------------------------------------------------------------ *
 * Detach filter from socket                                                  *
 * ------------------------------------------------------------------------ */
CHAOS_API(int filter_detach_socket(struct filter *fptr, int fd))

/* ------------------------------------------------------------------------ *
 * Attach a filter to a listener                                              *
 * ------------------------------------------------------------------------ */
CHAOS_API(int filter_attach_listener(struct filter *fptr, struct listen *liptr))

/* ------------------------------------------------------------------------ *
 * Detach filter from listener                                                *
 * ------------------------------------------------------------------------ */
CHAOS_API(int filter_detach_listener(struct filter *fptr, struct listen *liptr))
