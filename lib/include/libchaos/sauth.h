...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct sauth *sauth_dns_forward(const char *address, void *callback,
                                          ...))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct sauth *sauth_dns_reverse(net_addr_t address, void *callback,
                                          ...))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct sauth *sauth_auth(net_addr_t address, net_port_t local,
                                   net_port_t remote, void *callback, ...))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct sauth *sauth_proxy(int type, net_addr_t remote_addr,
...
CHAOS_API(struct sauth *sauth_userdb(const char *cmd, const char *args,
                                     void *callback, ...))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void sauth_vset_args(struct sauth *sauth, va_list args))

CHAOS_API(void sauth_set_args(sauth_t *sauth, ...))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct sauth *sauth_push(struct sauth **))
