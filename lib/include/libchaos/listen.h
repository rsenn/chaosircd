 ...
 * Global variables                                                           *
 * ------------------------------------------------------------------------ */
CHAOS_DATA(int) listen_log;
CHAOS_DATA(struct sheap) listen_heap; /* heap containing listen blocks */
CHAOS_DATA(struct list) listen_list;  /* list linking listen blocks */
CHAOS_DATA(uint32_t) listen_id;
CHAOS_DATA(int) listen_dirty;
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct listen *listen_add(const char *address, uint16_t port,
                                    int backlog, int ssl, const char *context,
                                    const char *protocol))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(int listen_update(struct listen *liptr, int backlog, int ssl,
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct listen *listen_find(const char *address, uint16_t port))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void listen_set_args(struct listen *liptr, const void *argbuf,
                               size_t n))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void listen_get_args(struct listen *liptr, void *argbuf, size_t n))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void listen_set_name(struct listen *liptr, const char *name))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(int listen_attach_filter(struct listen *lptr, struct filter *fptr))
