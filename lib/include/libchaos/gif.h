 ...
 * MA 02111-1307, USA
 *
 * $Id: gif.h,v 1.3 2006/09/28 08:38:31 roman Exp $
 */
 ...
 * Create GIF instance                                                        *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct gif *gif_new(const char *name, int state))

/* ------------------------------------------------------------------------ *
 * Open GIF file                                                              *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct gif *gif_open(const char *filename, int state))

/* ------------------------------------------------------------------------ *
 * Open GIF filedescriptor                                                    *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct gif *gif_open_fd(int fd, int state))

/* ------------------------------------------------------------------------ *
 * Open GIF from/to mem                                                       *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct gif *gif_open_mem(void *mem, size_t n, int state))
 ...
 * ------------------------------------------------------------------------- */
CHAOS_API(int gif_screen_put(struct gif *gif, uint16_t width, uint16_t height,
                             int resolution, uint8_t background,
                             struct palette *pal))
/* ------------------------------------------------------------------------- *
 * Get an image                                                                *
 * ------------------------------------------------------------------------- */
 ...
 * Put an image                                                                *
 * ------------------------------------------------------------------------- */
CHAOS_API(int gif_image_put(struct gif *gif, int16_t left, int16_t top,
 ...
 * ------------------------------------------------------------------------- */
CHAOS_API(int gif_data_get(struct gif *gif, uint8_t *data, uint32_t len))

/* ------------------------------------------------------------------------- *
 * Put data into current image                                                 *
 * ------------------------------------------------------------------------- */
CHAOS_API(int gif_data_put(struct gif *gif, uint8_t *data, uint32_t len))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct gif_image *gif_image_add(struct gif *gif, int16_t left,
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void gif_image_delete(struct gif *gif, struct gif_image *image))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(int gif_get_gfx_control(struct gif_image *image, int *disposal,
                                  int *user_input, int *trans, uint16_t *delay))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(int gif_put_gfx_control(struct gif *gif, int disposal, int user_input,
