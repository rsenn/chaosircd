 ...
 * Global variables                                                         *
 * ------------------------------------------------------------------------ */
CHAOS_DATA(int) connect_log;              /* Log source */
CHAOS_DATA(struct sheap) connect_heap;    /* Heap containing connect blocks */
CHAOS_DATA(struct timer *) connect_timer; /* Garbage collect timer */
CHAOS_DATA(struct list) connect_list;     /* List linking connect blocks */
CHAOS_DATA(uint32_t) connect_id;          /* Next serial number */
 ...
 * ------------------------------------------------------------------------ */
CHAOS_API(struct connect *connect_add(const char *address, uint16_t port,
 ...
 * <ssl>               SSL connection?                                      *
 * ------------------------------------------------------------------------ */
CHAOS_API(int connect_update(struct connect *cnptr, const char *address,
                             uint16_t port, struct protocol *pptr,
                             uint64_t timeout, uint64_t interval, int autoconn,
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void connect_set_arg(struct connect *cnptr, void *arg))

/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void connect_set_args(struct connect *cnptr, const void *argbuf,
                                size_t n))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void connect_set_name(struct connect *cnptr, const char *name))
