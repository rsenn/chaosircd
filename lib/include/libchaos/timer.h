...
#define TIMER_MAX_INTERVAL                                                     \
  (24LL * 3600LL * 1000LL) /* max. interval = 1 day                            \
                            */
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(size_t timer_strftime(char *s, size_t max, const char *format,
                                const struct tm *tm))
 ...
 * ------------------------------------------------------------------------ */
CHAOS_API(void timer_to_timeval(struct timeval *dst, uint64_t *src))
 ...
 * ------------------------------------------------------------------------ */
CHAOS_API(struct timer *timer_start(void *callback, uint64_t interval, ...))
 ...
 * ------------------------------------------------------------------------ */
CHAOS_API(int timer_find_cancel(void *callback, void *userarg))
 ...
 *                   - your args                                              *
 * ------------------------------------------------------------------------ */
CHAOS_API(void timer_vnote(struct timer *timer, const char *format,
                           va_list args))

CHAOS_API(void timer_note(struct timer *timer, const char *format, ...))
 ...
 *                   - your args                                              *
 * ------------------------------------------------------------------------ */
CHAOS_API(void timer_find_note(struct timer *timer, const char *format, ...))
