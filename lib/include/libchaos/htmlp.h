...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_DATA(int) htmlp_log;
CHAOS_DATA(struct sheap) htmlp_heap;
CHAOS_DATA(struct sheap) htmlp_var_heap;
CHAOS_DATA(struct dheap) htmlp_dheap;
CHAOS_DATA(struct list) htmlp_list;
CHAOS_DATA(uint32_t) htmlp_id;
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(int htmlp_parse(struct htmlp *htmlp, const char *data, size_t n))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(void htmlp_vset_args(struct htmlp *htmlp, va_list args))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct htmlp_tag *htmlp_tag_index(struct htmlp *htptr, uint32_t i))
...
/* ------------------------------------------------------------------------ *
 * ------------------------------------------------------------------------ */
CHAOS_API(struct htmlp_var *htmlp_var_set(struct htmlp *htptr, const char *name,
                                          const char *value))
