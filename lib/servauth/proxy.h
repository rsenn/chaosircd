...
extern int proxy_lookup(struct proxy_check *proxy, net_addr_t addr,
                        net_port_t port, net_addr_t testaddr,
                        net_port_t testport, int type, uint64_t t);
extern void proxy_set_userarg(struct proxy_check *proxy, void *arg);
extern void *proxy_get_userarg(struct proxy_check *proxy);
extern void proxy_set_callback(struct proxy_check *proxy, proxy_callback_t *cb,
                               uint64_t timeout);
#endif
