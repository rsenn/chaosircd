 ...
 *
 * $Id: numeric.h,v 1.2 2006/09/28 08:38:31 roman Exp $
 */
...
#define RPL_DENYLIST         344
#define RPL_ENDOFDENYLIST    345
...
#define RPL_AOPLIST          354
#define RPL_ENDOFAOPLIST     355
#define RPL_AHOPLIST         356
#define RPL_ENDOFAHOPLIST    357
#define RPL_AVOICELIST       358
#define RPL_ENDOFAVOICELIST  359
...
/* -------------------------------------------------------------------------- *
 * -------------------------------------------------------------------------- */
IRCD_API(void)        numeric_vsend  (struct client  *cptr,
                                      int             numeric,
                                      va_list         args);

IRCD_API(void)        numeric_send   (struct client  *cptr,
                                      int             numeric,
                                      ...);

/* -------------------------------------------------------------------------- *
 * -------------------------------------------------------------------------- */
IRCD_API(void)        numeric_vlsend (struct lclient *lcptr,
                                      int             numeric,
                                      va_list         args);

IRCD_API(void)        numeric_lsend  (struct lclient *lcptr,
                                      int             numeric,
                                      ...);
