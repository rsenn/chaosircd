 ...
 * Prototypes                                                                 *
 * -------------------------------------------------------------------------- */
static void m_links(struct lclient *lcptr, struct client *cptr, int argc,
                    char **argv);
...
static struct msg m_links_msg = {
    "LINKS",     0, 1, MFLG_CLIENT, {NULL, m_links, m_links, m_links},
    m_links_help};
...
void m_links_unload(void) { msg_unregister(&m_links_msg); }
