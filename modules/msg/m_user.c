 ...
 * Prototypes                                                                 *
 * -------------------------------------------------------------------------- */
static void mr_user(struct lclient *lcptr, struct client *cptr, int argc,
                    char **argv);

static void ms_user(struct lclient *lcptr, struct client *cptr, int argc,
                    char **argv);
...
static struct msg m_user_msg = {"USER",
                                4,
                                4,
