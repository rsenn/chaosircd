 ...
 * Prototypes                                                                 *
 * -------------------------------------------------------------------------- */
static void m_info(struct lclient *lcptr, struct client *cptr, int argc,
                   char **argv);

/* -------------------------------------------------------------------------- *
 * Message entries                                                            *
 * -------------------------------------------------------------------------- */
static char *m_info_help[] = {"INFO [server]",
                              "",
...
static struct msg m_info_msg = {
    "INFO", 0, 1, MFLG_CLIENT, {NULL, m_info, m_info, m_info}, m_info_help};
...
static const char *m_info_text[] = {
    ...
    "",
    "               O      CH---CH      "
    "LSD is an abbreviation of the German chemical",
    "               \\\\    /  2    3     "
    "compound, Lysergsäure-diethylamid.",
    "                C---N              "
    "It was first synthesized in 1938 by the Swiss",
    "               /     \\             "
    "chemist Albert Hofmann in Basel at the Sandoz",
    "           ___/       CH           "
    "Laboratories as part of a large research prog-",
    "          /   \\      /  2          "
    "ram dealing with ergot alkaloid derivatives.",
    "   H C---N     |  H C              "
    "D-Lysergic Acid Diethylamide, commonly called",
    "    3     \\__//    3               "
    "acid, LSD, or LSD-25, is a powerful semisynth-",
    "          /   \\                    "
    "etic hallucinogen and psychedelic entheogen.",
    "         |     |---.               "
    "A typical dose of LSD is only 100 micrograms,",
    "          \\___/  `` \\              "
    "a tiny amount equal to 1/10th the weight of a",
    "          /   \\\\   //              "
    "grain of sand.  LSD causes a powerful intensi-",
    "          \\   / ---'               "
    "fication and alteration of feelings, memories,",
    "           `N'                     "
    "senses and self-awareness for 6-12 hours.  In",
    "            |                      "
    "addition, LSD usually produces visual effects",
    "            H                      "
    "such as brilliant colors, geometric patterns,",
    "                                   "
    "and \"trails\" behind moving objects.",
    "",
    "LSD usually does not produce hallucinations in the strict sense, but "
    "instead ill-",
    "usions and vivid daydream-like fantasies.  At higher concentrations it "
    "can cause",
    "synaesthesia. The pharmacological effects can be followed by long-lasting "
    "psycho-",
    "logical shifts such as changed views and mindset. LSD is synthesized from "
    "lyserg-",
    "ic acid and is sensitive to oxygen, ultra-violet light, and chlorine, "
    "especially",
    "in solution. In pure form it is colorless, odorless and bitter. LSD is "
    "typically",
    "delivered orally, usually on a substrate, such as absorbent blotter "
    "paper, sugar-",
    "cubes, or gelatin, although it is also possible to deliver it via food or "
    "drink.",
    "",
...
IRCD_MODULE(void) m_info_unload(void) { msg_unregister(&m_info_msg); }
