...
/* worst case: len*3 */
size_t fmt_quotedprintable2(char *dest, const char *src, size_t len,
                            const char *escapeme);
/* worst case: len*3 */
size_t fmt_urlencoded(char *dest, const char *src, size_t len);
/* worst case: len*3 */
size_t fmt_urlencoded2(char *dest, const char *src, size_t len,
                       const char *escapeme);
/* worst case: len*2 */
...
/* worst case: len*4 */
size_t fmt_cescape2(char *dest, const char *src, size_t len,
                    const char *escapeme);
...
size_t fmt_ldapescape2(char *dest, const char *src, size_t len,
                       const char *escapeme);
...
int fmt_to_sa(size_t (*func)(char *, const char *, size_t), stralloc *sa,
...
#ifdef ARRAY_H
void fmt_to_array(size_t (*func)(char *, const char *, size_t), array *a,
                  const char *src, size_t len);

void fmt_tofrom_array(size_t (*func)(char *, const char *, size_t), array *dest,
                      array *src);

void fmt_to_array2(size_t (*func)(char *, const char *, size_t, const char *),
                   array *a, const char *src, size_t len, const char *escapeme);

void fmt_tofrom_array2(size_t (*func)(char *, const char *, size_t,
                                      const char *),
