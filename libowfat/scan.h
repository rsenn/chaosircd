...
size_t scan_charsetnskip(const char *in, const char *charset,
                         size_t limit) __pure__;

/* return the highest integer n<=limit so that in[i] is not element of
 * charset (ASCIIZ string) for all 0<=i<=n */
size_t scan_noncharsetnskip(const char *in, const char *charset,
                            size_t limit) __pure__;
...
size_t scan_asn1derlength(const char *in, size_t len,
                          unsigned long long *n) __pure__;
size_t scan_asn1dertag(const char *in, size_t len,
                       unsigned long long *n) __pure__;
