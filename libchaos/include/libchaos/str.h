...
extern inline char *str_cat(char *d, const char *s)
{
  size_t i;
...
extern inline size_t str_copy(char *d, const char *s)
{
  size_t i = 0;
...
extern inline int str_cmp(const char *s1, const char *s2)
{
  size_t i = 0;
...
extern inline int str_toi(const char *s)
{   
