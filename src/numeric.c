 ...
 *
 * $Id: numeric.c,v 1.2 2006/09/28 08:38:31 roman Exp $
 */
 ...
 * -------------------------------------------------------------------------- */
char *numeric_replies[] = {
    /* 000 */ NULL,
    /* 001  RPL_WELCOME, */ ":welcome to the internet relay chat %s",
    /* 002  RPL_YOURHOST,*/ ":%s running %s (%s)",
    /* 003  RPL_CREATED, */ ":server up since %s",
    ...
    /* 018 */ NULL,
    /* 019 */ NULL,
    /* 020 RPL_YOURID */ "%s %s :your id and key is",
    /* 021 */ NULL,
    /* 022 */ NULL,
    /* 023 */ NULL,
    /* 024 */ NULL,
    ...
    /* 216 RPL_STATSKLINE, */ "%c %s@%s %lu %s :%s",
    /* 217 RPL_STATSGLINE, */ "%c %s@%s %lu %s :%s",
    /* 218 RPL_STATSYLINE, */ "%c %s %d %d %d %lu",
    ...
    /* 249 */ NULL,
    /* 250 RPL_STATSCONN, */
    "max. local/remote clients: %u/%u (%u connections received)",
    /* 251 RPL_LUSERCLIENT, */
    ":there are %u users and %u invisible on %u servers",
    ...
    /* 267 RPL_LOCALSSL */ ":current local SSL users: %d max: %d",
    /* 268 RPL_GLOBALSSL */ ":current global SSL users: %d max: %d",
    /* 269 */ NULL,
    /* 270 */ NULL,
    /* 271 */ NULL,
    /* 272 */ NULL,
    /* 273 */ NULL,
    /* 274 */ NULL,
    /* 275 RPL_WHOISSSL, */ "%s :is paranoid (%s)",
    /* 276 */ NULL,
    /* 277 */ NULL,
    /* 278 */ NULL,
    /* 279 */ NULL,
    ...
    /* 336 */ NULL,
    /* 337 */ NULL,
    /* 338 RPL_WHOISACTUALLY */ ":%s is actually %s@%s [%s]",
    /* 339 */ NULL,
    /* 340 */ NULL,
    /* 341 RPL_INVITING, */ "%s %s",
    /* 342 RPL_SUMMONING, */ NULL,
    /* 343 */ NULL,
    /* 344 RPL_DENYLIST */ "%s %s %s %lu",
    /* 345 RPL_ENDOFDENYLIST */ "%s :end of channel deny list",
    ...
    /* 350 */ NULL,
    /* 351 RPL_VERSION, */ "%s-%s.%s %s :%s",
    /* 352 RPL_WHOREPLY, */ "%s %s %s %s %s %s :%d %s",
    /* 353 RPL_NAMREPLY, */ "%s %s :",
    /* 354 RPL_AOPLIST */ "%s %s %s %lu",
    /* 355 RPL_ENDOFAOPLIST */ "%s :end of channel auto-op list",
    /* 356 RPL_AHOPLIST */ "%s %s %s %lu",
    /* 357 RPL_ENDOFAHOPLIST */ "%s :end of channel auto-halfop list",
    /* 358 RPL_AVOICELIST */ "%s %s %s %lu",
    /* 359 RPL_ENDOFAVOICELIST */ "%s :end of channel auto-voice list",
    /* 360 */ NULL,
    ...
    /* 407 ERR_TOOMANYTARGETS, */ "%s :too many recipients.",
    /* 408 */ NULL,
    ...
    /* 418 */ NULL,
    /* 419 */ NULL,
    /* 420 ERR_SERVERCOMMAND, */ "%s :server-only command",
    ...
    /* 437 ERR_ERR_UNAVAILRESOURCE */
    "%s :nick/channel is temporarily unavailable",
    /* 438 ERR_NICKTOOFAST */
    "%s %s :nick change too fast. please wait %d seconds.",
    /* 439 */ NULL,
    /* 440 */ NULL,
    ...
    /* 457 ERR_ACCEPTEXIST */ "%s :is already on your accept list",
    /* 458 ERR_ACCEPTNOT */ "%s :is not on your accept list",
    /* 459 */ NULL,
    /* 460 */ NULL,
    ...
    /* 468 */ NULL,
    /* 469 */ NULL,
    /* 470 ERR_DENIEDFROMCHAN */ "%s :cannot join channel (+d)",
    ...
    /* 477 ERR_MODELESS, */ "%s :channel does not support modes",
    ...
    /* 485 ERR_BANNEDNICK, */
    ":can't change nick when banned or on a moderated channel (%s)",
    /* 486 ERR_NOPLAINTEXT */ "%s :there are non-ssl users in the channel",
    /* 487 */ NULL,
    /* 488 */ NULL,
    /* 489 */ NULL,
    /* 490 */ NULL,
    ...
    /* 511 */ NULL,
    /* 512 */ NULL,
    /* 513 ERR_WRONGPONG */ ":to connect type /quote pong %s",
    /* 514 */ NULL,
    /* 515 */ NULL,
    /* 516 */ NULL,
    /* 517 */ NULL,
    ...
    /* 712 ERR_CHANOPEN */ "%s :channel is open.",
    /* 714 ERR_KNOCKONCHAN */ "%s :you are already on that channel.",
    /* 715 ERR_KNOCKDISABLED */ ":/knocks are disabled.",
    /* 716 */ NULL,
    /* 717 */ NULL,
    /* 718 */ NULL,
    /* 719 */ NULL,
    ...
    /* 997 */ NULL,
    /* 998 */ NULL,
    /* 999 LAST ERR_LAST_ERR_MSG,*/ ":last error message"};
